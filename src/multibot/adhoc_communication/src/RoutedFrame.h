...
* The class contains all needed frame fields and the functions to serialize a
frame or desizalied it from a buffer
*
...
{
  public:
    RoutedFrame(std::string topic_to_publish, std::string data,
    ...
    std::string getFrameAsNetworkString(routing_entry rou,
...
uint32_t RoutedFrame::HEADER_FIXED_LEN =
    sizeof(eh_header) + sizeof(rf_header); // 63
