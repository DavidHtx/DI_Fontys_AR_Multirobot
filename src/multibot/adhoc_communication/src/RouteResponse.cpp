 ...
 * ETH_TYPE_FIELD	// 0x4148 (AH as string)
 2Byte
 * FRAME_TYPE		// 0x72 (r as string)
 1Byte
 * REQUEST ID.		// Every node has a consecutive number for his requests
 4Byte
 * MC FLAG 1Byte
 * ROOT DISTANCE	// distancte to the mc root
 1Byte
 * HOB COUNT		// is the amount of node which are involved to process the
 packet	4Byte
 * CURRENT HOP 		// hop to be next to send
 4Byte
 * PATH				//the list of macs from the source to destination
 HOB COUNT * 6Byte
 ...
 *
 * Every node which receives an router response, checks first if he was involved
 in the route request and then checks if his mac is the current hop mac and
 forwards the response to the source.
...
RouteResponse::RouteResponse(RouteRequest request,
