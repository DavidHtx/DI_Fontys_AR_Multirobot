...
The PositionSubscripe class implements all function to build up a channel model
...
class PositionSubscriber
{
  public:
    ...
    */
    ...
    /*! callback method of the subscribed topic. Refreshes the robot position of
     the instance.
     *
    ...
    */
    ...
    uint32_t robot_number_;  ///< Number of the robot in stage. e.g: number of
                             ///"robot_0" would be "0"
