...
std::string
MultiHopBroadcastFrame::getFrameAsNetworkString(unsigned char *source)
{
    ...
    /*CRC*/
    uint32_t dynamic_field_len =
        this->hostname_source_.length() + topic_.length() + payload_.length();
