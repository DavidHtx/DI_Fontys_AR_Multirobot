/********************************************************************
 ********************************************************************
 ** C++ and STL class implementation of the Hungarian algorithm by David
 *Schwarz, 2012
 **
 **
...
Hungarian::Hungarian(const vector<vector<int>> &input_matrix, int rows,
                     int cols, MODE mode)
{
...
int Hungarian::init(const vector<vector<int>> &input_matrix, int rows, int cols,
                    MODE mode)
{
...
int Hungarian::cost() const { return m_cost; }
